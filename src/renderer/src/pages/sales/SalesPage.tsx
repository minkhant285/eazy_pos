              ...
              {!detail ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                  ...
                  <div>
                    ...
                    <select value={processedBy} onChange={(e) => setProcessedBy(e.target.value)} style={{ width: '100%', background: t.inputBg, border: `1px solid ${t.inputBorder}`, borderRadius: '10px', padding: '8px 12px', color: t.text, fontSize: '12px', outline: 'none', fontFamily: 'inherit' }}>
